...
urlpatterns = [
    ...
    path('cart/', views.cart_page, name='cart'), # New URL for cart
    path('cart/add/<int:variant_id>/', views.add_to_cart, name='add_to_cart'),
    path('cart/ajax/update/', views.ajax_update_cart_quantity, name='ajax_update_cart_quantity'),
    ...
    path('subcategory/<int:subcategory_id>/<slug:name>/',views.subcategory,name='subcategory'),
    path('storepreview/<int:store_id>',views.store_preview,name='store_preview'),
